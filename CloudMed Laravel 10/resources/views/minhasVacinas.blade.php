                            ...
                            <div class="flex items-end justufy-center">
                                ...
                                <div class="mr-1 w-3/5">
                                    <label for="filtroTipoDose"
                                        class="block mb-2 text-sm font-medium text-black dark:text-black">Tipo de
                                        Dose</label>
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-4 w-4/5 m-auto">
                    @foreach ($vacinas as $vacinas)
                        <div
                            ...
                            <div class="w-full">
                                <div
                                    class="inline-flex flex-wrap justify-between text-sm font-semibold w-full items-center">
                                ...
                                <div
                                    class="inline-flex flex-wrap justify-between text-sm font-semibold w-full content-center">
                                ...
                                <div
                                    ...
                                    <a href="{{ route('editVacina', $vacinas->id) }}">
                                        <button type="button"
                                            ...
                                            <svg aria-hidden="true" class="w-5 h-5 mr-5" fill="currentColor"
