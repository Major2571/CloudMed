                ...
                <div class="py-5">
                    <div class="title m-auto flex w-4/5 items-baseline justify-between">
                        <div class="w-1/2">
                            ...
                            <form method="GET" action="{{ route('myExams') }}" class="font-semibold">
                        ...
                        <div>
                            ...
                            <p class="mb-2 block text-sm font-medium text-black ">Data de Realização:</p>

                            <a href="{{ route('myExams', ['order' => 'desc']) }}">
                                <button type="button"
                            ...
                            <a href="{{ route('myExams', ['order' => 'asc']) }}">
                                <button type="button"
                                    class="inline-flex content-center items-center rounded-lg bg-cyan-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-cyan-800 focus:outline-none focus:ring-2 focus:ring-cyan-500">
                                    <div class="mr-2 flex">
