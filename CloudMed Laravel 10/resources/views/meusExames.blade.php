...
<x-app-layout>
    <section class="session-allow">
        ...
        <div class="min-h-screen max-h-full m-auto w-full ">
            ...
            <div class="tabela relative overflow-x-auto shadow-md sm:rounded-lg m-auto w-4/5">
                        ...
                        @foreach ($exames as $exames)
                            <tr class="bg-gray-50 border-gray-00 hover:bg-gray-100">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ asset('storage/arquivos_exames/' . $exames->nome_arquivo) }}" target="blank">
                                        <button type="button" 
                                            ...
                                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 576 512"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
