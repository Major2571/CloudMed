                ...
                @foreach ($exames as $exames)
                    <tr class="bg-white border-b dark:bg-gray-50 dark:border-gray-00 hover:bg-gray-100 dark:hover:bg-gray-200">
                        ...
                        <td class="px-6 py-4 text-center">
                            <button type="button" class="text-gray-500 border border-gray-500 hover:bg-gray-500 hover:text-white focus:ring-2 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2">
