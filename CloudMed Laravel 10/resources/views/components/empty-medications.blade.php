<section class="m-auto max-h-full min-h-screen w-full flex">
    ...
    <div class="mx-auto my-5 flex w-4/5 items-center justify-center flex-wrap">
        <div class="text-lg mr-5 w-1/3">
            <h1 class="leading-tight text-3xl">Você ainda não tem nenhum medicamento salvo</h1>
            <p class="py-5"> Para adicionar um medicamento clique no botão abaixo, e preencha as informações. </p>
        ...
        <div class="w-2/5">
            <img src="{{ url('assets/img/svg/emptyMedicamentos.svg') }}"  class="drop-shadow" alt="">
        </div>
    </div>
