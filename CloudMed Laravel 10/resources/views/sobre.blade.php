...
@section('contentMain')
    <div>
                ...
                <div class="inline-flex w-2/5 pr-20">
                    <div class="items-top inline-flex">
                        <div class="pl-5">
                            ...
                            <p class="mt-7 block text-lg leading-tight text-gray-900 drop-shadow-lg ">
        ...
        <div class="m-20">
            ...
            <div class="m-auto grid w-4/5 grid-cols-4 gap-10">
                ...
                <div class="w-full max-w-sm rounded-lg border border-gray-200 bg-white shadow-lg">
                    <div class="flex flex-col items-center pb-10">
                        ...
                        <span class="text-gray-500 dark:text-gray-400">Documentadora</span>
                        <div class="mt-4 flex space-x-3 md:mt-6">
            ...
            <p class="mx-auto my-10 w-3/4 text-center text-lg">
    ...
    <div class="mt-32 w-full">
        <div class="m-auto w-2/3 text-center">
            <h1>Obrigado!</h1>
            <div class="my-5 text-lg italic">
                <p>
                    Gostaríamos de expressar nossa sincera gratidão aos coordenadores e professores do curso por todo o
                    apoio,
                    orientação e incentivo ao longo de nossa jornada acadêmica e no desenvolvimento do projeto CloudMed.
                </p>
                <p>
            ...
            <div class="about-img">
                <img src="assets/img/svg/thanks.svg" alt="" class="m-auto w-1/2">
            </div>
        </div>
    </div>
@endsection
