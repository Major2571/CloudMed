    ...
    <section class="login session-allow">
                    ...
                    <div class="">
                        ...
                        <div class="px-10 py-5">
                            ...
                            <div class="grid md:grid-cols-2 md:gap-6">
                                ...
                                <div class="">
                                    ...
                                    <x-text-input type="text" name="cpf" id="cpf"
                                        placeholder="000 000 000 00" required />
                                </div>

                                <div class="">
                                    <x-input-label for="rg" :value="__('RG:')" />
                                    <x-text-input type="text" name="rg" id="rg"
                                ...
                                <div class="">
                                    ...
                                    <x-text-input type="tel" name="number" id="number"
                                ...
                                <div class="">
                                    ...
                                    <x-text-input type="text" name="cidade" id="cidade"
                        ...
                        <div class="px-10 py-5">
                            ...
                            <div class="grid md:grid-cols-2 md:gap-10">
                                ...
                                <div class="mb-6">
                                    <div class="relative w-full">
                                        <label for="tipo-sanguinio" class="block mb-2 font-medium text-gray-900"> Tipo
                                            Sanguínio </label>
                                        <select name="tipo-sanguinio"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-cyan-700 focus:border-cyan-700 block w-full p-2.5 pr-10">
        ...
        <div class="button">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit"
                    class="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-2 focus:outline-none focus:ring-red-50 font-medium rounded-lg px-7 py-2 text-center mr-2 mb-2">
                    Sair </button>
            </form>
        </div>
