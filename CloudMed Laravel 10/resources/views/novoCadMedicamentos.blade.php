                    ...
                    <div class="py-4 px-10">
                        ...
                        <div class="mb-3">
                            <div class="relative w-full">
                                ...
                                <x-text-input type="text" name="dosagem" id="dosagem" placeholder="Ex: 50mg"
                                    required />
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="relative w-full">
                                ...
                                <x-text-input type="text" name="laboratorio" placeholder="Ex: sNeo Química"
                                    id="laboratorio" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="relative w-full">
                                ...
                                <x-text-input type="text" name="frequencia" placeholder="Ex: Uso contínuo "
                                    id="frequencia" />
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="relative w-full">
                                ...
                                <x-text-input type="text" name="tratamento"
                                    placeholder="Ex: Pressão Alta / Hipertensão" id="tratamento" required />
                            </div>
                        </div>
